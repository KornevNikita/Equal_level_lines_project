...
extern "C" __declspec(dllexport) double limit_function0(double x, double y);
...
extern "C" __declspec(dllexport) int GetNumOfFuncs();
...
public:
  ...
  static double limit_func0(double x, double y);
